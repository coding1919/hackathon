        ...
        if (condition) {
            ...
            if (careRecommendations) {
                ...
                outputArea.innerHTML = `
                    <h2>If you have <span class="condition">${condition}</span></h2>
                    <div class="info">
                        <div class="info-left">
                            <h3>Description</h3>
                        ...
                        <div class="info-right">
                            <img src="images/${condition.toLowerCase()}.jpg" alt="${condition}" class="condition-image">
                        </div>
                    </div>
                    <h3>Care Recommendations</h3>
                    <ul>
                        ${careRecommendations.solutions.map((recommendation, index) => `
